...
describe('convertToRoman', () => {
  ...
  test('raises an error if argument is less than or equal zero', () => {
    expect(() => { convertToRoman(-15) }).toThrow(/Argument must be greater than zero/);
